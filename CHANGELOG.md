...
- Fixes JsonSerialization Exception for results with no actual address as these can include a numeric (non-string) value for "address_line1", which would fail deserialization previously. The fix simply deserializes the number as a string.
